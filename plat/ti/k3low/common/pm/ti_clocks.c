...
enum {
	...
	AM62LX_FREQ_VALUE_BOARD_0_GEMAC_CPTS0_RFT_CLK_OUT,
	...
	AM62LX_FREQ_VALUE_CPSW_MAIN_0_CPTS_GENF0,
	AM62LX_FREQ_VALUE_CPSW_MAIN_0_CPTS_GENF1,
	...
	AM62LX_FREQ_VALUE_DMC1MS_WKUP_0_TIMER_PWM,
	...
	AM62LX_FREQ_VALUE_A53_DIVH_CLK4_OBSCLK_OUT_CLK,
...
const struct ti_clk_range soc_clock_ranges[AM62LX_FREQ_RANGE_ID_MAX] = {
	TI_CLK_RANGE(AM62LX_FREQ_RANGE_ANY, 0, ULONG_MAX),
	TI_CLK_RANGE(AM62LX_FREQ_RANGE_GLUELOGIC_RCOSC_CLKOUT, 12500000, 12500000),
	TI_CLK_RANGE(AM62LX_FREQ_RANGE_GLUELOGIC_RCOSC_CLK_1P0V_97P65K, 97656, 97656),
	TI_CLK_RANGE(AM62LX_FREQ_RANGE_VCO_IN_PLLFRACF2_SSMOD_16FFT_MAIN_0, 5000000, 1200000000),
	TI_CLK_RANGE(AM62LX_FREQ_RANGE_VCO_PLLFRACF2_SSMOD_16FFT_MAIN_0, 800000000, 3200000000),
};

const struct ti_clk_default soc_clock_freq_defaults[5] = {
	TI_CLK_DEFAULT(FREQ_PLLFRACF2_SSMOD_16FFT_MAIN_0_DEFAULT,
		       1000000000UL, 1000000000UL, 1000000000UL),
	TI_CLK_DEFAULT(FREQ_PLLFRACF2_SSMOD_16FFT_MAIN_17_DEFAULT,
		       1800000000UL, 1800000000UL, 1800000000UL),
	TI_CLK_DEFAULT(FREQ_PLLFRACF2_SSMOD_16FFT_MAIN_8_DEFAULT,
		       2500000000UL, 2500000000UL, 2500000000UL),
	TI_CLK_DEFAULT(FREQ_PLLFRACF2_SSMOD_16FFT_WKUP_0_DEFAULT,
		       1200000000UL, 1200000000UL, 1200000000UL),
};

const struct ti_pll_table_entry ti_soc_pll_table[12] = {
	[PLL_ENTRY_WKUP_24MHZ_1200MHZ] = {
...
static const uint8_t pllfracf2_ssmod_16fft_main_0_entries[3] = {
	PLL_ENTRY_MAIN_24MHZ_1000MHZ_F24BIT,
	PLL_ENTRY_MAIN_25MHZ_1000MHZ,
	PLL_ENTRY_MAIN_26MHZ_1000MHZ_F24BIT,
};
static const uint8_t pllfracf2_ssmod_16fft_main_17_entries[3] = {
	PLL_ENTRY_DSS_24MHZ_1800MHZ,
	PLL_ENTRY_DSS_25MHZ_1800MHZ,
	PLL_ENTRY_DSS_26MHZ_1800MHZ_F24BIT,
};
static const uint8_t pllfracf2_ssmod_16fft_main_8_entries[3] = {
	PLL_ENTRY_ARM0_24MHZ_2500MHZ_F24BIT,
	PLL_ENTRY_ARM0_25MHZ_2500MHZ,
	PLL_ENTRY_ARM0_26MHZ_2500MHZ_F24BIT,
};
static const uint8_t pllfracf2_ssmod_16fft_wkup_0_entries[3] = {
	PLL_ENTRY_WKUP_24MHZ_1200MHZ,
	PLL_ENTRY_WKUP_25MHZ_1200MHZ,
	PLL_ENTRY_WKUP_26MHZ_1200MHZ_F24BIT,
};

static const struct ti_clk_parent clk_ADC0_CLKSEL_parents[4] = {
	{
	...
	{
		CLK_AM62LX_POSTDIV4_WKUP_0_HSDIVOUT8_CLK,
		1,
	},
	{
...
static const struct ti_clk_data_mux_reg clk_data_ADC0_CLKSEL_out0 = {
	.data_mux = {
		.parents = clk_ADC0_CLKSEL_parents,
		.num_parents = ARRAY_SIZE(clk_ADC0_CLKSEL_parents),
	},
	.reg = 0x09100000 + 430080,
	.bit = 0,
};
static const struct ti_clk_parent clk_AUDIO_REFCLKn_out0_parents[8] = {
	{
	...
	{
		CLK_AM62LX_POSTDIV4_MAIN_0_HSDIVOUT8_CLK,
		1,
	},
	{
...
static const struct ti_clk_data_mux_reg clk_data_AUDIO_REFCLKn_out0 = {
	.data_mux = {
		.parents = clk_AUDIO_REFCLKn_out0_parents,
		.num_parents = ARRAY_SIZE(clk_AUDIO_REFCLKn_out0_parents),
	},
	.reg = 0x09100000 + 294912,
	.bit = 0,
};
static const struct ti_clk_data_mux_reg clk_data_AUDIO_REFCLKn_out1 = {
	.data_mux = {
		.parents = clk_AUDIO_REFCLKn_out0_parents,
		.num_parents = ARRAY_SIZE(clk_AUDIO_REFCLKn_out0_parents),
	},
...
static const struct ti_clk_parent clk_CLKOUT0_CTRL_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_CLKOUT0_CTRL_out0 = {
	.data_mux = {
		.parents = clk_CLKOUT0_CTRL_parents,
		.num_parents = ARRAY_SIZE(clk_CLKOUT0_CTRL_parents),
	},
	.reg = 0x09100000 + 40960,
	.bit = 0,
};
static const struct ti_clk_parent clk_CLK_32K_RC_SEL_parents[4] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_CLK_32K_RC_SEL_out0 = {
	.data_mux = {
		.parents = clk_CLK_32K_RC_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_CLK_32K_RC_SEL_parents),
	},
	.reg = 0x43020000 + 256,
	.bit = 0,
};
static const struct ti_clk_parent clk_MAIN_CP_GEMAC_CPTS_CLK_SEL_parents[8] = {
	{
		CLK_AM62LX_POSTDIV4_WKUP_0_HSDIVOUT7_CLK,
		1,
	},
	{
		CLK_AM62LX_POSTDIV4_MAIN_0_HSDIVOUT6_CLK,
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_CP_GEMAC_CPTS_CLK_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_CP_GEMAC_CPTS_CLK_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_CP_GEMAC_CPTS_CLK_SEL_parents),
	},
	.reg = 0x09100000 + 253952,
	.bit = 0,
};
static const struct ti_clk_parent clk_MAIN_DPHYTX_REFCLK_parents[2] = {
	{
		CLK_AM62LX_GLUELOGIC_HFOSC0_CLK,
		1,
	},
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_DPHYTX_REFCLK_out0 = {
	.data_mux = {
		.parents = clk_MAIN_DPHYTX_REFCLK_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_DPHYTX_REFCLK_parents),
	},
	.reg = 0x09100000 + 405504,
	.bit = 0,
};
static const struct ti_clk_parent clk_MAIN_DSS_DPI0_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_DSS_DPI0_out0 = {
	.data_mux = {
		.parents = clk_MAIN_DSS_DPI0_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_DSS_DPI0_parents),
	},
	.reg = 0x09100000 + 372736,
	.bit = 0,
};
static const struct ti_clk_parent clk_MAIN_EMMCSD0_IO_CLKLB_SEL_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_EMMCSD0_IO_CLKLB_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_EMMCSD0_IO_CLKLB_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_EMMCSD0_IO_CLKLB_SEL_parents),
	},
	.reg = 0x09180000 + 45056,
	.bit = 0,
};
static const struct ti_clk_parent clk_MAIN_EMMCSD0_REFCLK_SEL_parents[2] = {
	{
		CLK_AM62LX_POSTDIV4_MAIN_0_HSDIVOUT5_CLK,
		1,
	},
	{
		CLK_AM62LX_POSTDIV4_WKUP_0_HSDIVOUT9_CLK,
		1,
	},
};
static const struct ti_clk_data_mux_reg clk_data_MAIN_EMMCSD0_REFCLK_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_EMMCSD0_REFCLK_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_EMMCSD0_REFCLK_SEL_parents),
	},
	.reg = 0x09100000 + 45056,
	.bit = 0,
};
static const struct ti_clk_parent clk_MAIN_EMMCSD1_IO_CLKLB_SEL_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_EMMCSD1_IO_CLKLB_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_EMMCSD1_IO_CLKLB_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_EMMCSD1_IO_CLKLB_SEL_parents),
	},
	.reg = 0x09180000 + 49152,
	.bit = 0,
};
static const struct ti_clk_data_mux_reg clk_data_MAIN_EMMCSD1_REFCLK_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_EMMCSD0_REFCLK_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_EMMCSD0_REFCLK_SEL_parents),
	},
...
static const struct ti_clk_parent clk_MAIN_EMMCSD2_IO_CLKLB_SEL_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_EMMCSD2_IO_CLKLB_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_EMMCSD2_IO_CLKLB_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_EMMCSD2_IO_CLKLB_SEL_parents),
	},
	.reg = 0x09180000 + 53248,
	.bit = 0,
};
static const struct ti_clk_data_mux_reg clk_data_MAIN_EMMCSD2_REFCLK_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_EMMCSD0_REFCLK_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_EMMCSD0_REFCLK_SEL_parents),
	},
...
static const struct ti_clk_parent clk_MAIN_GPMC_FCLK_SEL_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_GPMC_FCLK_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_GPMC_FCLK_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_GPMC_FCLK_SEL_parents),
	},
	.reg = 0x09100000 + 81920,
	.bit = 0,
};
static const struct ti_clk_parent clk_MAIN_MCANn_CLK_SEL_out0_parents[4] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_MCANn_CLK_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_MCANn_CLK_SEL_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_MCANn_CLK_SEL_out0_parents),
	},
	.reg = 0x09100000 + 262144,
	.bit = 0,
};
static const struct ti_clk_data_mux_reg clk_data_MAIN_MCANn_CLK_SEL_out1 = {
	.data_mux = {
		.parents = clk_MAIN_MCANn_CLK_SEL_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_MCANn_CLK_SEL_out0_parents),
	},
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_MCANn_CLK_SEL_out2 = {
	.data_mux = {
		.parents = clk_MAIN_MCANn_CLK_SEL_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_MCANn_CLK_SEL_out0_parents),
	},
...
static const struct ti_clk_parent clk_MAIN_OBSCLK0_MUX_SEL_parents[16] = {
	{
		CLK_AM62LX_HSDIV4_16FFT_MAIN_0_HSDIVOUT0_CLK,
		1,
	},
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_OBSCLK0_MUX_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_OBSCLK0_MUX_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_OBSCLK0_MUX_SEL_parents),
	},
	.reg = 0x09100000 + 36864,
	.bit = 0,
};
static const struct ti_clk_data_div_reg_go clk_data_MAIN_OBSCLK_DIV_out0 = {
	.data_div = {
		.max_div = 256,
	},
...
static const struct ti_clk_parent clk_MAIN_OBSCLK_OUTMUX_SEL_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_OBSCLK_OUTMUX_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_OBSCLK_OUTMUX_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_OBSCLK_OUTMUX_SEL_parents),
	},
	.reg = 0x09100000 + 36864,
	.bit = 24,
};
static const struct ti_clk_parent clk_MAIN_OSPI_LOOPBACK_CLK_SEL_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_OSPI_LOOPBACK_CLK_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_OSPI_LOOPBACK_CLK_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_OSPI_LOOPBACK_CLK_SEL_parents),
	},
	.reg = 0x09180000 + 69632,
	.bit = 4,
};
static const struct ti_clk_parent clk_MAIN_OSPI_REF_CLK_SEL_parents[2] = {
	{
		CLK_AM62LX_POSTDIV4_MAIN_0_HSDIVOUT7_CLK,
		1,
	},
	{
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_OSPI_REF_CLK_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_OSPI_REF_CLK_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_OSPI_REF_CLK_SEL_parents),
	},
	.reg = 0x09100000 + 69632,
	.bit = 0,
};
static const struct ti_clk_parent clk_MAIN_TIMER1_CASCADE_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_TIMER1_CASCADE_out0 = {
	.data_mux = {
		.parents = clk_MAIN_TIMER1_CASCADE_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_TIMER1_CASCADE_parents),
	},
	.reg = 0x09180000 + 90112,
	.bit = 8,
};
static const struct ti_clk_parent clk_MAIN_TIMER3_CASCADE_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_TIMER3_CASCADE_out0 = {
	.data_mux = {
		.parents = clk_MAIN_TIMER3_CASCADE_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_TIMER3_CASCADE_parents),
	},
	.reg = 0x09180000 + 98304,
	.bit = 8,
};
static const struct ti_clk_parent clk_MAIN_TIMERCLKn_SEL_out0_parents[16] = {
	{
		CLK_AM62LX_GLUELOGIC_HFOSC0_CLK,
		1,
	},
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_TIMERCLKn_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_TIMERCLKn_SEL_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_TIMERCLKn_SEL_out0_parents),
	},
	.reg = 0x09100000 + 86016,
	.bit = 0,
};
static const struct ti_clk_data_mux_reg clk_data_MAIN_TIMERCLKn_SEL_out1 = {
	.data_mux = {
		.parents = clk_MAIN_TIMERCLKn_SEL_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_TIMERCLKn_SEL_out0_parents),
	},
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_TIMERCLKn_SEL_out2 = {
	.data_mux = {
		.parents = clk_MAIN_TIMERCLKn_SEL_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_TIMERCLKn_SEL_out0_parents),
	},
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_TIMERCLKn_SEL_out3 = {
	.data_mux = {
		.parents = clk_MAIN_TIMERCLKn_SEL_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_TIMERCLKn_SEL_out0_parents),
	},
...
static const struct ti_clk_data_div_reg_go clk_data_MAIN_USART_CLKDIV_out0 = {
	.data_div = {
		.max_div = 4,
	},
...
static const struct ti_clk_data_div_reg_go clk_data_MAIN_USART_CLKDIV_out1 = {
	.data_div = {
		.max_div = 4,
	},
...
static const struct ti_clk_data_div_reg_go clk_data_MAIN_USART_CLKDIV_out2 = {
	.data_div = {
		.max_div = 4,
	},
...
static const struct ti_clk_data_div_reg_go clk_data_MAIN_USART_CLKDIV_out3 = {
	.data_div = {
		.max_div = 4,
	},
...
static const struct ti_clk_data_div_reg_go clk_data_MAIN_USART_CLKDIV_out4 = {
	.data_div = {
		.max_div = 4,
	},
...
static const struct ti_clk_data_div_reg_go clk_data_MAIN_USART_CLKDIV_out5 = {
	.data_div = {
		.max_div = 4,
	},
...
static const struct ti_clk_data_div_reg_go clk_data_MAIN_USART_CLKDIV_out6 = {
	.data_div = {
		.max_div = 4,
	},
...
static const struct ti_clk_parent clk_MAIN_USB0_REFCLK_SEL_parents[2] = {
	{
		CLK_AM62LX_GLUELOGIC_HFOSC0_CLK,
		1,
	},
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_USB0_REFCLK_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_USB0_REFCLK_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_USB0_REFCLK_SEL_parents),
	},
	.reg = 0x43020000 + 20480,
	.bit = 0,
};
static const struct ti_clk_data_mux_reg clk_data_MAIN_USB1_REFCLK_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_USB0_REFCLK_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_USB0_REFCLK_SEL_parents),
	},
...
static const struct ti_clk_parent clk_MAIN_WWDTCLKn_SEL_out0_parents[4] = {
	{
		CLK_AM62LX_GLUELOGIC_HFOSC0_CLK,
		1,
	},
...
static const struct ti_clk_data_mux_reg clk_data_MAIN_WWDTCLKn_SEL_out0 = {
	.data_mux = {
		.parents = clk_MAIN_WWDTCLKn_SEL_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_WWDTCLKn_SEL_out0_parents),
	},
	.reg = 0x09100000 + 118784,
	.bit = 0,
};
static const struct ti_clk_data_mux_reg clk_data_MAIN_WWDTCLKn_SEL_out1 = {
	.data_mux = {
		.parents = clk_MAIN_WWDTCLKn_SEL_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MAIN_WWDTCLKn_SEL_out0_parents),
	},
...
static const struct ti_clk_parent clk_MCASPn_AHCLKSEL_AHCLKR_out0_parents[4] = {
	{
		CLK_AM62LX_BOARD_0_EXT_REFCLK1_OUT,
		1,
	},
...
static const struct ti_clk_data_mux_reg clk_data_MCASPn_AHCLKSEL_AHCLKR_out0 = {
	.data_mux = {
		.parents = clk_MCASPn_AHCLKSEL_AHCLKR_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MCASPn_AHCLKSEL_AHCLKR_out0_parents),
	},
	.reg = 0x09100000 + 299264,
	.bit = 0,
};
static const struct ti_clk_data_mux_reg clk_data_MCASPn_AHCLKSEL_AHCLKR_out1 = {
	.data_mux = {
		.parents = clk_MCASPn_AHCLKSEL_AHCLKR_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MCASPn_AHCLKSEL_AHCLKR_out0_parents),
	},
...
static const struct ti_clk_data_mux_reg clk_data_MCASPn_AHCLKSEL_AHCLKR_out2 = {
	.data_mux = {
		.parents = clk_MCASPn_AHCLKSEL_AHCLKR_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MCASPn_AHCLKSEL_AHCLKR_out0_parents),
	},
...
static const struct ti_clk_data_mux_reg clk_data_MCASPn_AHCLKSEL_AHCLKX_out0 = {
	.data_mux = {
		.parents = clk_MCASPn_AHCLKSEL_AHCLKR_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MCASPn_AHCLKSEL_AHCLKR_out0_parents),
	},
...
static const struct ti_clk_data_mux_reg clk_data_MCASPn_AHCLKSEL_AHCLKX_out1 = {
	.data_mux = {
		.parents = clk_MCASPn_AHCLKSEL_AHCLKR_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MCASPn_AHCLKSEL_AHCLKR_out0_parents),
	},
...
static const struct ti_clk_data_mux_reg clk_data_MCASPn_AHCLKSEL_AHCLKX_out2 = {
	.data_mux = {
		.parents = clk_MCASPn_AHCLKSEL_AHCLKR_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MCASPn_AHCLKSEL_AHCLKR_out0_parents),
	},
...
static const struct ti_clk_parent clk_MCASPn_CLKSEL_AUXCLK_out0_parents[2] = {
	{
		CLK_AM62LX_POSTDIV4_MAIN_0_HSDIVOUT8_CLK,
		1,
	},
...
static const struct ti_clk_data_mux_reg clk_data_MCASPn_CLKSEL_AUXCLK_out0 = {
	.data_mux = {
		.parents = clk_MCASPn_CLKSEL_AUXCLK_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MCASPn_CLKSEL_AUXCLK_out0_parents),
	},
	.reg = 0x09100000 + 299008,
	.bit = 0,
};
static const struct ti_clk_data_mux_reg clk_data_MCASPn_CLKSEL_AUXCLK_out1 = {
	.data_mux = {
		.parents = clk_MCASPn_CLKSEL_AUXCLK_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MCASPn_CLKSEL_AUXCLK_out0_parents),
	},
...
static const struct ti_clk_data_mux_reg clk_data_MCASPn_CLKSEL_AUXCLK_out2 = {
	.data_mux = {
		.parents = clk_MCASPn_CLKSEL_AUXCLK_out0_parents,
		.num_parents = ARRAY_SIZE(clk_MCASPn_CLKSEL_AUXCLK_out0_parents),
	},
...
static const struct ti_clk_data_mux_reg clk_data_WKUP_CLKOUT_SEL_out0 = {
	.data_mux = {
		.parents = clk_WKUP_CLKOUT_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_WKUP_CLKOUT_SEL_parents),
	},
	.reg = 0x43020000 + 12288,
	.bit = 0,
};
static const struct ti_clk_parent clk_WKUP_CLKOUT_SEL_IO_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_WKUP_CLKOUT_SEL_IO_out0 = {
	.data_mux = {
		.parents = clk_WKUP_CLKOUT_SEL_IO_parents,
		.num_parents = ARRAY_SIZE(clk_WKUP_CLKOUT_SEL_IO_parents),
	},
	.reg = 0x43020000 + 12292,
	.bit = 0,
};
static const struct ti_clk_parent clk_WKUP_GPIO0_CLKSEL_parents[4] = {
	{
		CLK_AM62LX_SAM62_PLL_CTRL_WRAP_WKUP_0_CHIP_DIV1_CLK_CLK,
		4,
	},
...
static const struct ti_clk_data_mux_reg clk_data_WKUP_GPIO0_CLKSEL_out0 = {
	.data_mux = {
		.parents = clk_WKUP_GPIO0_CLKSEL_parents,
		.num_parents = ARRAY_SIZE(clk_WKUP_GPIO0_CLKSEL_parents),
	},
	.reg = 0x43020000 + 32768,
	.bit = 0,
};
static const struct ti_clk_parent clk_WKUP_GTCCLK_SEL_parents[8] = {
	{
		CLK_AM62LX_POSTDIV4_WKUP_0_HSDIVOUT7_CLK,
		1,
	},
...
static const struct ti_clk_data_mux_reg clk_data_WKUP_GTCCLK_SEL_out0 = {
	.data_mux = {
		.parents = clk_WKUP_GTCCLK_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_WKUP_GTCCLK_SEL_parents),
	},
	.reg = 0x43020000 + 16384,
	.bit = 0,
};
static const struct ti_clk_parent clk_WKUP_GTC_OUTMUX_SEL_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_WKUP_GTC_OUTMUX_SEL_out0 = {
	.data_mux = {
		.parents = clk_WKUP_GTC_OUTMUX_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_WKUP_GTC_OUTMUX_SEL_parents),
	},
	.reg = 0x43020000 + 4096,
	.bit = 0,
};
static const struct ti_clk_parent clk_WKUP_OBSCLK_MUX_SEL_parents[16] = {
	{
		CLK_AM62LX_GLUELOGIC_RCOSC_CLKOUT,
		1,
	},
...
static const struct ti_clk_data_mux_reg clk_data_WKUP_OBSCLK_MUX_SEL_out0 = {
	.data_mux = {
		.parents = clk_WKUP_OBSCLK_MUX_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_WKUP_OBSCLK_MUX_SEL_parents),
	},
	.reg = 0x43020000 + 512,
	.bit = 0,
};
static const struct ti_clk_parent clk_WKUP_OBSCLK_OUTMUX_SEL_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_WKUP_OBSCLK_OUTMUX_SEL_out0 = {
	.data_mux = {
		.parents = clk_WKUP_OBSCLK_OUTMUX_SEL_parents,
		.num_parents = ARRAY_SIZE(clk_WKUP_OBSCLK_OUTMUX_SEL_parents),
	},
	.reg = 0x43020000 + 516,
	.bit = 0,
};
static const struct ti_clk_parent clk_WKUP_TIMER1_CASCADE_parents[2] = {
	{
...
static const struct ti_clk_data_mux_reg clk_data_WKUP_TIMER1_CASCADE_out0 = {
	.data_mux = {
		.parents = clk_WKUP_TIMER1_CASCADE_parents,
		.num_parents = ARRAY_SIZE(clk_WKUP_TIMER1_CASCADE_parents),
	},
	.reg = 0x43030000 + 12292,
	.bit = 8,
};
static const struct ti_clk_parent clk_WKUP_TIMERCLKn_SEL_out0_parents[8] = {
	{
		CLK_AM62LX_GLUELOGIC_HFOSC0_CLK,
		1,
	},
...
static const struct ti_clk_data_mux_reg clk_data_WKUP_TIMERCLKn_SEL_out0 = {
	.data_mux = {
		.parents = clk_WKUP_TIMERCLKn_SEL_out0_parents,
		.num_parents = ARRAY_SIZE(clk_WKUP_TIMERCLKn_SEL_out0_parents),
	},
	.reg = 0x43020000 + 8192,
	.bit = 0,
};
static const struct ti_clk_data_mux_reg clk_data_WKUP_TIMERCLKn_SEL_out1 = {
	.data_mux = {
		.parents = clk_WKUP_TIMERCLKn_SEL_out0_parents,
		.num_parents = ARRAY_SIZE(clk_WKUP_TIMERCLKn_SEL_out0_parents),
	},
...
static const struct ti_clk_data_from_dev clk_data_board_0_AUDIO_EXT_REFCLK0_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_AUDIO_EXT_REFCLK0_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_AUDIO_EXT_REFCLK1_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_AUDIO_EXT_REFCLK1_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_CP_GEMAC_CPTS0_RFT_CLK_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_CP_GEMAC_CPTS0_RFT_CLK_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_EXT_REFCLK1_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_EXT_REFCLK1_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_GPMC0_CLKLB_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_GPMC0_CLKLB_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_I2C0_SCL_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_I2C0_SCL_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_I2C1_SCL_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_I2C1_SCL_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_I2C2_SCL_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_I2C2_SCL_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_I2C3_SCL_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_I2C3_SCL_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MCASP0_ACLKR_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MCASP0_ACLKR_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MCASP0_ACLKX_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MCASP0_ACLKX_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MCASP0_AFSR_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MCASP0_AFSR_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MCASP0_AFSX_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MCASP0_AFSX_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MCASP1_ACLKR_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MCASP1_ACLKR_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MCASP1_ACLKX_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MCASP1_ACLKX_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MCASP1_AFSR_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MCASP1_AFSR_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MCASP1_AFSX_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MCASP1_AFSX_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MCASP2_ACLKR_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MCASP2_ACLKR_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MCASP2_ACLKX_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MCASP2_ACLKX_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MCASP2_AFSR_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MCASP2_AFSR_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MCASP2_AFSX_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MCASP2_AFSX_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MMC0_CLKLB_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MMC0_CLKLB_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MMC0_CLK_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MMC0_CLK_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MMC1_CLKLB_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MMC1_CLKLB_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MMC1_CLK_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MMC1_CLK_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MMC2_CLKLB_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MMC2_CLKLB_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_MMC2_CLK_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_MMC2_CLK_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_OSPI0_DQS_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_OSPI0_DQS_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_OSPI0_LBCLKO_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_OSPI0_LBCLKO_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_RMII1_REF_CLK_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_RMII1_REF_CLK_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_RMII2_REF_CLK_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_RMII2_REF_CLK_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_TCK_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_TCK_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_VOUT0_EXTPCLKIN_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_VOUT0_EXTPCLKIN_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_WKUP_EXT_REFCLK0_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_WKUP_EXT_REFCLK0_OUT,
};
static const struct ti_clk_data_from_dev clk_data_board_0_WKUP_I2C0_SCL_out = {
	.dev = AM62LX_DEV_BOARD0,
	.clk_idx = AM62LX_DEV_BOARD0_WKUP_I2C0_SCL_OUT,
};
static const struct ti_clk_data_from_dev clk_data_cpsw_3guss_am62l_main_0_cpts_genf0 = {
	.dev = AM62LX_DEV_CPSW0,
	.clk_idx = AM62LX_DEV_CPSW0_CPTS_GENF0,
};
static const struct ti_clk_data_from_dev clk_data_cpsw_3guss_am62l_main_0_cpts_genf1 = {
	.dev = AM62LX_DEV_CPSW0,
	.clk_idx = AM62LX_DEV_CPSW0_CPTS_GENF1,
};
static const struct ti_clk_data_from_dev clk_data_cpsw_3guss_am62l_main_0_mdio_mdclk_o = {
	.dev = AM62LX_DEV_CPSW0,
...
static const struct ti_clk_data_from_dev clk_data_dmtimer_dmc1ms_main_1_timer_pwm = {
	.dev = AM62LX_DEV_TIMER1,
	.clk_idx = AM62LX_DEV_TIMER1_TIMER_PWM,
};
static const struct ti_clk_data_from_dev clk_data_dmtimer_dmc1ms_main_2_timer_pwm = {
	.dev = AM62LX_DEV_TIMER2,
	.clk_idx = AM62LX_DEV_TIMER2_TIMER_PWM,
};
static const struct ti_clk_data_from_dev clk_data_dmtimer_dmc1ms_main_3_timer_pwm = {
	.dev = AM62LX_DEV_TIMER3,
	.clk_idx = AM62LX_DEV_TIMER3_TIMER_PWM,
};
static const struct ti_clk_data_from_dev clk_data_dmtimer_dmc1ms_wkup_0_timer_pwm = {
	.dev = AM62LX_DEV_WKUP_TIMER0,
	.clk_idx = AM62LX_DEV_WKUP_TIMER0_TIMER_PWM,
};
static const struct ti_clk_data_from_dev clk_data_emmcsd4ss_main_0_emmcsdss_io_clk_o = {
	.dev = AM62LX_DEV_MMCSD1,
	.clk_idx = AM62LX_DEV_MMCSD1_EMMCSDSS_IO_CLK_O,
};
static const struct ti_clk_data_from_dev clk_data_emmcsd4ss_main_1_emmcsdss_io_clk_o = {
	.dev = AM62LX_DEV_MMCSD2,
	.clk_idx = AM62LX_DEV_MMCSD2_EMMCSDSS_IO_CLK_O,
};
static const struct ti_clk_data_from_dev clk_data_emmcsd8ss_main_0_emmcsdss_io_clk_o = {
	.dev = AM62LX_DEV_MMCSD0,
	.clk_idx = AM62LX_DEV_MMCSD0_EMMCSDSS_IO_CLK_O,
};
static const struct ti_clk_data_from_dev clk_data_fss_ul_128_main_0_ospi0_oclk_clk = {
	.dev = AM62LX_DEV_FSS0,
	.clk_idx = AM62LX_DEV_FSS0_OSPI0_OCLK_CLK,
};
static const struct ti_clk_data_from_dev clk_data_gpmc_main_0_po_gpmc_dev_clk = {
	.dev = AM62LX_DEV_GPMC0,
	.clk_idx = AM62LX_DEV_GPMC0_PO_GPMC_DEV_CLK,
};
static const struct ti_clk_data_div_reg clk_data_hsdiv0_16fft_main_17_hsdiv0 = {
	.data_div = {
		.max_div = 128,
		.default_div = 9,
	},
...
static const struct ti_clk_data_div_reg clk_data_hsdiv0_16fft_main_8_hsdiv0 = {
	.data_div = {
		.max_div = 128,
		.default_div = 2,
	},
...
static const struct ti_clk_data_div_reg clk_data_hsdiv0_16fft_wkup_0_hsdiv0 = {
	.data_div = {
		.max_div = 128,
		.default_div = 6,
	},
...
static const struct ti_clk_data_div_reg clk_data_hsdiv0_16fft_wkup_32khz_gen_0_hsdiv0 = {
	.data_div = {
		.max_div = 128,
	},
...
static const struct ti_clk_data_div_reg clk_data_hsdiv4_16fft_main_0_hsdiv0 = {
	.data_div = {
		.max_div = 128,
		.default_div = 4,
	},
...
static const struct ti_clk_data_div_reg clk_data_hsdiv4_16fft_main_0_hsdiv2 = {
	.data_div = {
		.max_div = 128,
		.default_div = 5,
	},
...
static const struct ti_clk_data_div_reg clk_data_hsdiv4_16fft_main_0_hsdiv3 = {
	.data_div = {
		.max_div = 128,
		.default_div = 15,
	},
...
static const struct ti_clk_data_div_reg clk_data_hsdiv4_16fft_main_0_hsdiv4 = {
	.data_div = {
		.max_div = 128,
		.default_div = 25,
	},
...
static const struct ti_clk_data_div_reg clk_data_hsdiv4_16fft_wkup_0_hsdiv0 = {
	.data_div = {
		.max_div = 128,
		.default_div = 6,
	},
...
static const struct ti_clk_data_div_reg clk_data_hsdiv4_16fft_wkup_0_hsdiv1 = {
	.data_div = {
		.max_div = 128,
		.default_div = 25,
	},
...
static const struct ti_clk_data_div_reg clk_data_hsdiv4_16fft_wkup_0_hsdiv2 = {
	.data_div = {
		.max_div = 128,
		.default_div = 25,
	},
...
static const struct ti_clk_data_div_reg clk_data_hsdiv4_16fft_wkup_0_hsdiv3 = {
	.data_div = {
		.max_div = 128,
		.default_div = 40,
	},
...
static const struct ti_clk_data_div_reg clk_data_hsdiv4_16fft_wkup_0_hsdiv4 = {
	.data_div = {
		.max_div = 128,
		.default_div = 18,
	},
...
static const struct ti_clk_data_from_dev clk_data_k3_dss_nano_main_0_dpi_0_out_clk = {
	.dev = AM62LX_DEV_DSS0,
	.clk_idx = AM62LX_DEV_DSS0_DPI_0_OUT_CLK,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_0_mcasp_aclkr_pout = {
	.dev = AM62LX_DEV_MCASP0,
	.clk_idx = AM62LX_DEV_MCASP0_MCASP_ACLKR_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_0_mcasp_aclkx_pout = {
	.dev = AM62LX_DEV_MCASP0,
	.clk_idx = AM62LX_DEV_MCASP0_MCASP_ACLKX_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_0_mcasp_afsr_pout = {
	.dev = AM62LX_DEV_MCASP0,
	.clk_idx = AM62LX_DEV_MCASP0_MCASP_AFSR_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_0_mcasp_afsx_pout = {
	.dev = AM62LX_DEV_MCASP0,
	.clk_idx = AM62LX_DEV_MCASP0_MCASP_AFSX_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_0_mcasp_ahclkr_pout = {
	.dev = AM62LX_DEV_MCASP0,
	.clk_idx = AM62LX_DEV_MCASP0_MCASP_AHCLKR_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_0_mcasp_ahclkx_pout = {
	.dev = AM62LX_DEV_MCASP0,
	.clk_idx = AM62LX_DEV_MCASP0_MCASP_AHCLKX_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_1_mcasp_aclkr_pout = {
	.dev = AM62LX_DEV_MCASP1,
	.clk_idx = AM62LX_DEV_MCASP1_MCASP_ACLKR_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_1_mcasp_aclkx_pout = {
	.dev = AM62LX_DEV_MCASP1,
	.clk_idx = AM62LX_DEV_MCASP1_MCASP_ACLKX_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_1_mcasp_afsr_pout = {
	.dev = AM62LX_DEV_MCASP1,
	.clk_idx = AM62LX_DEV_MCASP1_MCASP_AFSR_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_1_mcasp_afsx_pout = {
	.dev = AM62LX_DEV_MCASP1,
	.clk_idx = AM62LX_DEV_MCASP1_MCASP_AFSX_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_1_mcasp_ahclkr_pout = {
	.dev = AM62LX_DEV_MCASP1,
	.clk_idx = AM62LX_DEV_MCASP1_MCASP_AHCLKR_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_1_mcasp_ahclkx_pout = {
	.dev = AM62LX_DEV_MCASP1,
	.clk_idx = AM62LX_DEV_MCASP1_MCASP_AHCLKX_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_2_mcasp_aclkr_pout = {
	.dev = AM62LX_DEV_MCASP2,
	.clk_idx = AM62LX_DEV_MCASP2_MCASP_ACLKR_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_2_mcasp_aclkx_pout = {
	.dev = AM62LX_DEV_MCASP2,
	.clk_idx = AM62LX_DEV_MCASP2_MCASP_ACLKX_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_2_mcasp_afsr_pout = {
	.dev = AM62LX_DEV_MCASP2,
	.clk_idx = AM62LX_DEV_MCASP2_MCASP_AFSR_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_2_mcasp_afsx_pout = {
	.dev = AM62LX_DEV_MCASP2,
	.clk_idx = AM62LX_DEV_MCASP2_MCASP_AFSX_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_2_mcasp_ahclkr_pout = {
	.dev = AM62LX_DEV_MCASP2,
	.clk_idx = AM62LX_DEV_MCASP2_MCASP_AHCLKR_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mcasp_main_2_mcasp_ahclkx_pout = {
	.dev = AM62LX_DEV_MCASP2,
	.clk_idx = AM62LX_DEV_MCASP2_MCASP_AHCLKX_POUT,
};
static const struct ti_clk_data_from_dev clk_data_mshsi2c_main_0_porscl = {
	.dev = AM62LX_DEV_I2C0,
	.clk_idx = AM62LX_DEV_I2C0_PORSCL,
};
static const struct ti_clk_data_from_dev clk_data_mshsi2c_main_1_porscl = {
	.dev = AM62LX_DEV_I2C1,
	.clk_idx = AM62LX_DEV_I2C1_PORSCL,
};
static const struct ti_clk_data_from_dev clk_data_mshsi2c_main_2_porscl = {
	.dev = AM62LX_DEV_I2C2,
	.clk_idx = AM62LX_DEV_I2C2_PORSCL,
};
static const struct ti_clk_data_from_dev clk_data_mshsi2c_main_3_porscl = {
	.dev = AM62LX_DEV_I2C3,
	.clk_idx = AM62LX_DEV_I2C3_PORSCL,
};
static const struct ti_clk_data_from_dev clk_data_mshsi2c_wkup_0_porscl = {
	.dev = AM62LX_DEV_WKUP_I2C0,
	.clk_idx = AM62LX_DEV_WKUP_I2C0_PORSCL,
};
static const struct ti_clk_data_pll_16fft clk_data_pllfracf2_ssmod_16fft_main_0 = {
	.data_pll = {
...
static const struct ti_clk_data_div clk_data_pllfracf2_ssmod_16fft_main_0_postdiv = {
	.max_div = 49,
};
static const struct ti_clk_data_pll_16fft clk_data_pllfracf2_ssmod_16fft_main_17 = {
	.data_pll = {
		.vco_range_idx = AM62LX_FREQ_RANGE_VCO_PLLFRACF2_SSMOD_16FFT_MAIN_0,
		.vco_in_range_idx = AM62LX_FREQ_RANGE_VCO_IN_PLLFRACF2_SSMOD_16FFT_MAIN_0,
		.fractional_support = true,
...
static const struct ti_clk_data_pll_16fft clk_data_pllfracf2_ssmod_16fft_main_8 = {
	.data_pll = {
		.vco_range_idx = AM62LX_FREQ_RANGE_VCO_PLLFRACF2_SSMOD_16FFT_MAIN_0,
		.vco_in_range_idx = AM62LX_FREQ_RANGE_VCO_IN_PLLFRACF2_SSMOD_16FFT_MAIN_0,
		.fractional_support = true,
...
static const struct ti_clk_data_pll_16fft clk_data_pllfracf2_ssmod_16fft_wkup_0 = {
	.data_pll = {
		.vco_range_idx = AM62LX_FREQ_RANGE_VCO_PLLFRACF2_SSMOD_16FFT_MAIN_0,
		.vco_in_range_idx = AM62LX_FREQ_RANGE_VCO_IN_PLLFRACF2_SSMOD_16FFT_MAIN_0,
		.fractional_support = true,
...
static const struct ti_clk_data_div clk_data_pllfracf2_ssmod_16fft_wkup_0_postdiv = {
	.max_div = 49,
};
static const struct ti_clk_data_div_reg clk_data_postdiv4_16ff_main_0_hsdiv5 = {
	.data_div = {
		.max_div = 128,
		.default_div = 5,
	},
...
static const struct ti_clk_data_div_reg clk_data_postdiv4_16ff_main_0_hsdiv6 = {
	.data_div = {
		.max_div = 128,
		.default_div = 4,
	},
...
static const struct ti_clk_data_div_reg clk_data_postdiv4_16ff_main_0_hsdiv7 = {
	.data_div = {
		.max_div = 128,
		.default_div = 5,
	},
...
static const struct ti_clk_data_div_reg clk_data_postdiv4_16ff_main_0_hsdiv8 = {
	.data_div = {
		.max_div = 128,
		.default_div = 10,
	},
...
static const struct ti_clk_data_div_reg clk_data_postdiv4_16ff_main_0_hsdiv9 = {
	.data_div = {
		.max_div = 128,
		.default_div = 3,
	},
...
static const struct ti_clk_data_div_reg clk_data_postdiv4_16ff_wkup_0_hsdiv6 = {
	.data_div = {
		.max_div = 128,
		.default_div = 24,
	},
...
static const struct ti_clk_data_div_reg clk_data_postdiv4_16ff_wkup_0_hsdiv7 = {
	.data_div = {
		.max_div = 128,
		.default_div = 6,
	},
...
static const struct ti_clk_data_div_reg clk_data_postdiv4_16ff_wkup_0_hsdiv8 = {
	.data_div = {
		.max_div = 128,
		.default_div = 40,
	},
...
static const struct ti_clk_data_div_reg clk_data_postdiv4_16ff_wkup_0_hsdiv9 = {
	.data_div = {
		.max_div = 128,
		.default_div = 6,
	},
...
static const struct ti_clk_parent clk_sam62_pll_ctrl_wrap_wkup_0_parents[2] = {
	{
		CLK_AM62LX_GLUELOGIC_HFOSC0_CLK,
		1,
	},
...
static const struct ti_clk_data_mux_reg clk_data_sam62_pll_ctrl_wrap_wkup_0_sysclkout_clk = {
	.data_mux = {
		.parents = clk_sam62_pll_ctrl_wrap_wkup_0_parents,
		.num_parents = ARRAY_SIZE(clk_sam62_pll_ctrl_wrap_wkup_0_parents),
	},
	.reg = 0x00410000,
};
static const struct ti_clk_data_div_reg clk_data_sam62_pll_ctrl_wrap_wkup_0_chip_div1_clk_clk = {
	.data_div = {
		.max_div = 32,
	},
...
static const struct ti_clk_data_div_reg clk_data_sam62_pll_ctrl_wrap_wkup_0_chip_div24_clk_clk = {
	.data_div = {
		.max_div = 32,
	},
...
static const struct ti_clk_data_from_dev clk_data_spi_main_1_io_clkspio_clk = {
	.dev = AM62LX_DEV_MCSPI1,
	.clk_idx = AM62LX_DEV_MCSPI1_IO_CLKSPIO_CLK,
};
static const struct ti_clk_data_from_dev clk_data_spi_main_2_io_clkspio_clk = {
	.dev = AM62LX_DEV_MCSPI2,
	.clk_idx = AM62LX_DEV_MCSPI2_IO_CLKSPIO_CLK,
};
static const struct ti_clk_data_from_dev clk_data_spi_main_3_io_clkspio_clk = {
...
static const uint32_t hfosc0_supported_freqs[] = {
	25000000U,
	0U,
};
static const struct ti_clk_data_hfosc0 clk_data_hfosc0 = {
	.wkup_ctrl_mmr_base = 0x43010000UL,
	.devstat_offset = 0x30UL,
	.devstat_freq_mask = 0x7U,
	.supported_freqs = hfosc0_supported_freqs,
};
static const struct ti_clk_data_lfosc0 clk_data_lfosc0 = {
	.rtc_base = 0x2b1f0000UL,
	.lfxosc_ctrl_offset = 0x80UL,
	.disable_mask = 0x80UL,
	.freq_hz = 32768U,
};

struct ti_clk soc_clocks[] = {
	[CLK_AM62LX_GLUELOGIC_HFOSC0_CLK] = {
		.ref_count = 0,
		.flags = 0,
		.drv = &ti_clk_drv_soc_hfosc0,
		.data = &clk_data_hfosc0.data,
		.data_flags = 0,
	},
	[CLK_AM62LX_GLUELOGIC_LFOSC0_CLK] = {
		.ref_count = 0,
		.flags = 0,
		.drv = &ti_clk_drv_soc_lfosc0,
		.data = &clk_data_lfosc0.data,
		.data_flags = 0,
	},
	[CLK_AM62LX_GLUELOGIC_RCOSC_CLKOUT] = {
		.ref_count = 0,
	...
	[CLK_AM62LX_BOARD_0_GEMAC_CPTS0_RFT_CLK_OUT] = {
		...
		.freq_idx = AM62LX_FREQ_VALUE_BOARD_0_GEMAC_CPTS0_RFT_CLK_OUT,
	},
	[CLK_AM62LX_BOARD_0_EXT_REFCLK1_OUT] = {
		.ref_count = 0,
		.flags = 0,
	...
	[CLK_AM62LX_CPSW_MAIN_0_CPTS_GENF0] = {
		...
		.freq_idx = AM62LX_FREQ_VALUE_CPSW_MAIN_0_CPTS_GENF0,
	},
	[CLK_AM62LX_CPSW_MAIN_0_CPTS_GENF1] = {
		.ref_count = 0,
		.flags = 0,
		...
		.freq_idx = AM62LX_FREQ_VALUE_CPSW_MAIN_0_CPTS_GENF1,
	},
	...
	[CLK_AM62LX_DMC1MS_WKUP_0_TIMER_PWM] = {
		...
		.freq_idx = AM62LX_FREQ_VALUE_DMC1MS_WKUP_0_TIMER_PWM,
	},
	...
	[CLK_AM62LX_PLLFRACF2_SSMOD_16FFT_MAIN_0_FOUTPOSTDIV_CLK] = {
		...
		.ref_count = 0,
		.flags = 0,
		.drv = &ti_clk_drv_div_pll_16fft_postdiv.drv,
		.type = TI_CLK_TYPE_DIV,
	...
	[CLK_AM62LX_POSTDIV4_MAIN_0_HSDIVOUT5_CLK] = {
		...
		.ref_count = 0,
		.flags = 0,
		.drv = &ti_clk_drv_div_pll_16fft_postdiv_hsdiv.drv,
		.data_flags = 0,
		.type = TI_CLK_TYPE_DIV,
	...
	[CLK_AM62LX_POSTDIV4_MAIN_0_HSDIVOUT9_CLK] = {
		.parent = {
			CLK_AM62LX_PLLFRACF2_SSMOD_16FFT_MAIN_0_FOUTPOSTDIV_CLK,
			1,
		},
	...
	[CLK_AM62LX_POSTDIV4_WKUP_0_HSDIVOUT6_CLK] = {
		.parent = {
			CLK_AM62LX_PLLFRACF2_SSMOD_16FFT_WKUP_0_FOUTPOSTDIV_CLK,
			1,
		},
	...
	[CLK_AM62LX_A53_DIVH_CLK4_OBSCLK_OUT_CLK] = {
		...
		.data_flags = 0,
		.data =
		&clk_data_a53_divh_clk4_obsclk_out_clk.data,
		.freq_idx =
		AM62LX_FREQ_VALUE_A53_DIVH_CLK4_OBSCLK_OUT_CLK,
	},
	...
	[CLK_AM62LX_CLKOUT0_CTRL_OUT0] = {
		.ref_count = 0,
		.flags = 0,
		.drv = &ti_clk_drv_mux_reg.drv,
		.data_flags = 0,
		.data = &clk_data_CLKOUT0_CTRL_out0.data_mux.data,
		.type = TI_CLK_TYPE_MUX,
	},
	[CLK_AM62LX_CLK_32K_RC_SEL_OUT0] = {
		.ref_count = 0,
		.flags = 0,
	...
	[CLK_AM62LX_HSDIV0_16FFT_MAIN_17_HSDIVOUT0_CLK] = {
		...
		.data_flags = TI_CLK_DATA_FLAG_MODIFY_PARENT_FREQ,
		.type = TI_CLK_TYPE_DIV,
	...
	[CLK_AM62LX_SAM62_PLL_CTRL_WRAP_WKUP_0_SYSCLKOUT_CLK] = {
		.ref_count = 0,
		.flags = 0,
		.drv = &ti_clk_drv_pllctrl_mux_reg_ro.drv,
		.data_flags = 0,
...
const size_t soc_clock_count = ARRAY_SIZE(soc_clocks);
const size_t soc_clock_range_count = AM62LX_FREQ_RANGE_ID_MAX;
const size_t soc_clock_value_count = AM62LX_FREQ_VALUE_COUNT;
const size_t soc_clock_freq_defaults_count = ARRAY_SIZE(soc_clock_freq_defaults);
