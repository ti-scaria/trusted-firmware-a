...
#define A53_0_HOST_ID	(0xAU)
#define MIN_CTX_RESTORE_SEQ_ID	(0x12U)
...
static void __dead2 k3_bl1_handoff(void)
{
	...
	if (is_rtc_only_ddr_exit == true) {
		a53_tifs_msg_obj.req.hdr.host = A53_0_HOST_ID;
		a53_tifs_msg_obj.req.hdr.seq = MIN_CTX_RESTORE_SEQ_ID;
