...
__wkupsramfunc static void pll_cal_option3(uint32_t pll_base)
{
	uint32_t cal;
 ...
 */
__wkupsramfunc static void pll_enable(uint32_t pll_base, bool enable)
{
	uint32_t ctrl;
 ...
 */
__wkupsramfunc static void pll_bypass(struct pll_raw_data *pll, bool enable)
{
	uint32_t ctrl;
...
__wkupsramfunc static void pll_disable_hsdiv(struct pll_raw_data *pll,
					     uint8_t hsdiv)
{
	uint32_t ctrl;
...
__wkupsramfunc static void pll_enable_hsdiv(struct pll_raw_data *pll,
					    uint8_t hsdiv)
{
	uint32_t ctrl;
...
__wkupsramfunc void k3low_pll_save(struct pll_raw_data *pll)
{
	uint8_t i;
	uint32_t cfg;
...
__wkupsramfunc void k3low_pll_disable(struct pll_raw_data *pll)
{
...
__wkupsramfunc void k3low_pll_bypass_hsdivs(struct pll_raw_data *pll)
{
	uint8_t i;
	uint32_t cfg;
...
__wkupsramfunc void k3low_pll_program_hsdiv(struct pll_raw_data *pll,
