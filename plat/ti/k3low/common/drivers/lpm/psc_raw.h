 ...
 */
int32_t k3low_psc_raw_pd_wait(uint64_t psc_base, uint8_t pd);
 ...
 * pd:       power domain index.
 */
void k3low_psc_raw_pd_initiate(uint64_t psc_base, uint8_t pd);
 ...
 */
void k3low_psc_raw_pd_set_state(uint64_t psc_base, uint8_t pd,
