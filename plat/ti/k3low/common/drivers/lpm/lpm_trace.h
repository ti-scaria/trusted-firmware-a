...
/*
 * Output a uint32_t trace value to the configured trace destinations.
 *
 * value: trace value to output.
 */
...
#define LPM_SEQ_USB_LPSC_DISABLE		0x8U
...
#define LPM_SEQ_ENABLE_USB_LPSC			0xEU
